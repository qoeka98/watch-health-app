...
def run_ml():
    ...
    **❓ 하지만 기존 데이터만으로 충분할까?**  
    기존 변수들은 개별적인 수치일 뿐, **질병과의 관계를 직접적으로 반영하지 못함** → **새로운 건강 위험 예측 변수 추가!**

    ---

    ## 🏗 **데이터 가공 및 특성 엔지니어링**  
    📊 **더 나은 예측을 위해 새로운 특성을 추가했습니다!**  
    ...
    st.markdown('''데이터 출처  : https://www.data.go.kr/data/15007122/fileData.do''')
