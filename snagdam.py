...
def is_health_related(text):
    ...
    health_keywords = [
        ...
        # ✅ 생활 습관 및 예방 관련 키워드
        "면역력", "스트레스 관리", "수면", "불면증", "건강검진", "예방접종", "운동법","운동","건강개선","식단",
        "근력 운동", "유산소 운동", "요가", "필라테스", "명상", "호흡법",

        # ✅ 특정 검사 및 수치 관련 키워드
        "혈당 수치", "혈압 수치", "체지방률", "BMI", "콜레스테롤 검사", "간 수치",
        "신장 기능 검사", "심전도", "혈액형", "빈혈 검사","건강상태","건강","질병"
    ]
    ...
    **예시 질문:**  
    ...
    if chat:
        ...
        if not is_health_related(clean_chat):
            ...
            system_prompt = (
                "너는 건강, 의학, 의료, 약학, 한의학, 당뇨병, 비만,다이어트, 고지혈증, 고혈압 전문가 AI야. "
                "사용자의 질문을 분석하고, 정확한 답변만 제공해. "
               
                "당신은 건강관련 전문가 AI 입니다. 특히 비만,다이어트트, 고지혈증 , 당뇨, 고혈압에 특화되어있습니다"
            )
